namespace Product_Inventory_Management_System.Controllers
{
    ...
    public class ProductInformationWebApiController : Controller
    {
        ...
        public ProductInformationWebApiController(ILogger<HomeController> logger, IProductInformationService productInformationService, IValidator<ProductInformation> validator)
        {
            _logger = logger;
